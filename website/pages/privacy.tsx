...
export default function PrivacyCopy() {
  return (
    <Layout>
      <React.Fragment>
        <Jumbotron header="Privacy Policy" leadingParagraph="" />
        ...
        <div className="md:container md:mx-auto sm:pb-52 pb-4 px-4">
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at YozaClean unless
          ...
          <p>
            ...
            <a
              href="mailto://hello@yozaclean.com"
              className="underline text-blue-600">
              hello@yozaclean.com
            </a>
            .
