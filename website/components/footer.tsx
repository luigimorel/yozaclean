      ...
      <div className=" mx-auto max-w-screen-xl">
        ...
        <div className="mx-6 py-10 text-start">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="">
              <h6 className="uppercase font-semibold mb-4 flex text-gray-500 dark:text-gray-300 md:justify-start">
                YozaClean
              </h6>
              ...
              <div className="flex w-full">
                ...
                <a
                  href="#!"
                  className="mr-8 text-gray-500 dark:text-gray-300 dark:hover:text-primary   hover:text-primary focus:text-primary">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fab"
