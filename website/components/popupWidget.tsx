  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-primary rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-primary focus:bg-primary ease">
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                            errors.name
                              ...
                              : "border-gray-300 focus:border-primabg-primary ring-indigo-100"
                          }`}
                        />
                        {errors.name && (
                  ...
                  {isSubmitSuccessful && isSuccess && (
                    <>
                      <div className="flex flex-col items-center justify-center h-full text-center text-white rounded-md">
                        ...
                        <button
                          className="mt-6 text-primabg-primary focus:outline-none"
                          onClick={() => reset()}
                        >
                          Go back
                        </button>
